...
let newopt1 = opt1js.value;
if (opt1js.value == 1000) {
...
let calcjs2 = document.getElementById("btnCalc2");
calcjs2.addEventListener("click", calculateIcecreame)


function calculateIcecreame(e) {
    e.preventDefault();
    ...
    let quantity = document.getElementById("quantityInput").value;
        ...
        let thirtyPercentDiscount = newopt3*quantity*0.3;
        let fourtyPercentDiscount = newopt3*quantity*0.4;
